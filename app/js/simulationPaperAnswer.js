    ...
    methods:{
        ...
        getOne:function(){
            if(this.shijuan!=null){
                axios.get('http://bl.mxmba.com/index.php?c=question_moni_ctrl&m=answer_sheet_no_hand&shijuan='+this.shijuan)
                    .then(response=>{
        ...
        sendPaper:function () {
            axios.get('http://bl.mxmba.com/index.php?c=question_moni_ctrl&m=answer_sheet_to_hand&shijuan='+this.shijuan+'&time='+this.time)
                .then(response=>{
                    this.dialogVisible1 = false;
                    location.href="simulationPaperScore.html?shijuan="+this.shijuan+"&time="+this.time;
                }).catch(response=> {
                console.log(response);
            });
        },
