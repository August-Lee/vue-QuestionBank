...
new Vue({
    ...
    methods:{
        setImg:function(){
            ...
            axios.get('http://bl.mxmba.com/index.php?c=question_moni_ctrl&m=save_timu',
                {
                    params: {jsonList}
                })
        ...
        getOne:function(){
            ...
            time=0;
            $(".main").scrollTop(0)
            axios.get('http://bl.mxmba.com/index.php?c=question_moni_ctrl&m=sel&exam_paper_id='+this.shijuan+'&timu_id='+this.timuId+'&time='+this.nothing)
                .then(response=>{
        ...
        yichu:function(){
            ...
            if(this.is_wrong=="加入错题"){
                axios.get('http://bl.mxmba.com/index.php?c=tiku_exam_point_ctrl&m=join_mistake&question_id='+this.timuId)
                    .then(function (response) {
                        console.log(response);
        ...
        handleChange:function() {
            ...
            if(this.isShow==false){
                ...
                console.log(jsonList);
                axios.get('http://bl.mxmba.com/index.php?c=question_moni_ctrl&m=timu_sign',
                    {
                        params: {jsonList}
                    })
                    .then(function (response) {
