...
new Vue({
    ...
    methods:{
        ...
        getList:function(){
            ...
            axios.get('http://bl.mxmba.com/index.php?c=tiku_exam_point_ctrl&m=get_one_point_msg')
                .then(function (response) {
        ...
        open6:function(pid,cp,type,ti) {
            console.log(pid,cp,type,ti);
            if(ti==0){
                this.$message({
                    message: '考点下暂无习题',
                    center: true
                        ...
                        axios.get('http://bl.mxmba.com/index.php?c=tiku_exam_point_ctrl&m=del_answer&id='+pid+'&sub_id='+cp)
                            .then(function (response) {
                                ...
                                if(response.data.status==0){
                                    ...
                                    location.href="PracticeInterface.html?kemu="+pid+"&timu="+' ';
                                }else{
                                    that.$message({
                                        type: 'success',
                                        message: '删除失败!'
                        ...
                        axios.get('http://bl.mxmba.com/index.php?c=tiku_exam_point_ctrl&m=del_answer&point_id='+pid+'&sub_id='+cp)
                            .then(function (response) {
                                if(response.data.status==0){
                                    ...
                                    location.href="PracticeInterface.html?pointId="+pid+"&timu="+' ';
                                }else{
                                    that.$message({
                                        type: 'success',
                                        message: '删除失败!'
